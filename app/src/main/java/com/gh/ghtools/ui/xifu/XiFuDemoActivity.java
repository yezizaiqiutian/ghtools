package com.gh.ghtools.ui.xifu;
 ...
 * @from:
 */
public class XiFuDemoActivity extends BaseActivity {
    ...
    private TextView id_tv_001;
    private TextView id_tv_002;
    private TextView id_tv_003;
    private TextView id_tv_004;
    private TextView id_tv_005;
    private TextView id_tv_006;
    ...
    public static void access(Context context) {
        ...
        intent.setClass(context, XiFuDemoActivity.class);
    ...
    protected void initView() {
        ...
        id_tv_001 = findViewById(R.id.id_tv_001);
        id_tv_002 = findViewById(R.id.id_tv_002);
        id_tv_003 = findViewById(R.id.id_tv_003);
        id_tv_004 = findViewById(R.id.id_tv_004);
        id_tv_005 = findViewById(R.id.id_tv_005);
        id_tv_006 = findViewById(R.id.id_tv_006);
        anchorList.add(id_tv_001);
        anchorList.add(id_tv_002);
        anchorList.add(id_tv_003);
        anchorList.add(id_tv_004);
        anchorList.add(id_tv_005);
        anchorList.add(id_tv_006);
...
//        }
        ...
        listener = new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                View anchorView = anchorList.get(anchorList.size() - 1);
